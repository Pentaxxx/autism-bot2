...
if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN не найден в переменных окружения!")TIMER_SECONDS = 10
ROUNDS = 5
...
class DuelStates(StatesGroup):
    answering = State()
    waiting_username = State()   # для вызова друга
...
# ========== ВЫЗОВ ПО ЮЗЕРНЕЙМУ (через состояние) ==========
...
# Обработчик ввода username для вызова друга
...
# ========== ОРИГИНАЛЬНАЯ КОМАНДА FIND (для кнопки) ==========
